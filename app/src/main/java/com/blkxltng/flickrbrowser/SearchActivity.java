...
public class SearchActivity extends BaseActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        SearchManager searchMangager = (SearchManager) getSystemService(Context.SEARCH_SERVICE);
        mSearchView.setSearchableInfo(searchMangager.getSearchableInfo((getComponentName())));
